    ...
    try {
        ...
        if ($action === 'create') {
            ...
            if (
                ...
                !in_array($accountStatus, $accountStatuses, true)
            ) {
        ...
        header(
            'Location: users.php?status=success&message=' .
        ...
        header(
            'Location: users.php?status=error&message=' .
            ...
            >
                ...
                <div>
                    ...
                    <select name="account_status">
                        ...
                        <?php foreach ($accountStatuses as $value): ?>
                            ...
                            <td class="action-cell">
                                ...
                                <?php if ($r['role'] !== 'admin'): ?>
                                    ...
                                    <form
                                        method="post"
                                        class="inline-form"
                                        onsubmit="return confirm('Delete this user? Their related viewing/application records will also be removed by the database cascade.');"
                                    >
