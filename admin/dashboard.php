...
<html lang="en"><head>
    ...
    <title>Admin Dashboard | Obeda Dormitories</title>
...
<div class="admin-layout">
    <aside>
        ...
        <nav>
            <a class="active" href="dashboard.php">Dashboard</a><a href="viewing_requests.php">Viewing Requests</a><a href="room_applications.php">Room Applications</a><a href="rooms.php">Rooms</a><a href="dormitories.php">Dormitories</a><a href="users.php">Users</a>
        </nav>
    </aside>
...
<?php if($message): ?>
    <div class="alert <?= $status === 'error' ? 'error' : 'success' ?>"><?= h($message) ?>
</div>
<?php endif; ?>
<div class="welcome">Welcome, <?= h($_SESSION['first_name'] ?? 'Administrator') ?>.
</div>
<div class="stats"><div>
    <strong><?= $pendingViewings ?></strong>
...
<section class="panel">
    ...
    <div class="quick-links">
        <a href="viewing_requests.php">Manage viewing requests</a>
        <a href="room_applications.php">Manage room applications</a>
        <a href="rooms.php">Manage rooms</a>
        <a href="users.php">Manage customer accounts</a>
    </div>
</section>
</main>
</div>
