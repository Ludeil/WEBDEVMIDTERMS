...
<head>
    ...
    <title>
        Available Rooms | Obeda Dormitories
    </title>
    ...
    <div class="room-grid">
        ...
        <?php foreach ($rooms as $r): ?>
            ...
            <article class="panel room-card">
                ...
                <a
                    class="button"
                    href="application.php?room_id=<?= h(
                        (string) $r['id']
                    ) ?>"
                >
                    Apply for this room
        ...
        <?php if (!$rooms): ?>
            ...
            <section class="panel">
                ...
                <p>
                    There are currently no rooms marked available.
                    Please check again later or schedule a viewing.
                </p>
